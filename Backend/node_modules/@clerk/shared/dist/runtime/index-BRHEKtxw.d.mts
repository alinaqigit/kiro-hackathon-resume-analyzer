...
type MeEnterpriseConnectionProvider = 'saml_custom' | 'saml_okta' | 'saml_google' | 'saml_microsoft' | 'oidc_custom' | 'oidc_github_enterprise' | 'oidc_gitlab';
type MeEnterpriseConnectionSamlInput = {
...
type MeEnterpriseConnectionOidcInput = {
...
type CreateMeEnterpriseConnectionParams = {
...
type UpdateMeEnterpriseConnectionParams = {
  name?: string | null;
  active?: boolean | null;
...
interface UserResource extends ClerkResource, BillingPayerMethods {
  ...
  updateEnterpriseConnection: (enterpriseConnectionId: string, params: UpdateMeEnterpriseConnectionParams) => Promise<EnterpriseConnectionResource>;
 ...
 */
type __experimental_ConfigureSSOProps = {
  /**
   * Customisation options to fully match the Clerk components to your own brand.
   * These options serve as overrides and will be merged with the global `appearance`
   * prop of ClerkProvider (if one is provided)
...
//#endregion
export { CreateOrganizationParams as $, JwtHeader as $a, SignUpVerificationsJSONSnapshot as $c, OrganizationCreationAdvisoryType as $d, OAuthProvider as $f, RoleJSON as $i, UsernameIdentifier as $l, isUserLockedError as $n, CreateExternalAccountParams as $o, GetPaymentMethodsParams as $p, SignUpFutureWeb3Params as $r, AttemptEmailAddressVerificationParams as $s, WaitlistModalProps as $t, ClerkAPIResponseError as $u, AuthenticateWithBaseParams as A, TransparentColor as Aa, APIKeysSettingsJSONSnapshot as Ac, SignUpModes as Ad, Web3ProviderData as Af, EnterpriseAccountConnectionJSON as Ai, SignInFutureSSOParams as Al, DeletedObjectResource as Am, SignUpErrors as An, CheckAuthorizationFromSessionClaims as Ao, BillingPlanResource as Ap, ProfilePageId as Ar, EnterpriseConnectionTestRunLogResource as As, SignInButtonProps as At, TOTPFactor as Au, CheckoutSignalValue as B, SignUpStatus as Ba, IdentificationLinkJSONSnapshot as Bc, ProtectConfigJSON as Bd, FacebookOauthProvider as Bf, OrganizationInvitationJSON as Bi, SignInAuthenticateWithSolanaParams as Bl, isClerkAPIResponseError as Bm, WaitlistResource as Bn, SessionResource as Bo, BillingSubscriptionPlanPeriod as Bp, SignUpFutureAdditionalParams as Br, GetEnterpriseConnectionTestRunsParams as Bs, SignUpModalProps as Bt, UpdatePasskeyParams as Bu, DevToolsResource as C, FontWeight as Ca, EnterpriseProtocol as Cc, EnterpriseSSOSettings as Cd, BaseWeb3Provider as Cf, BillingSubscriptionJSON as Ci, SignInFuturePasswordParams as Cl, SnakeToCamel as Cm, NullableSignInSignal as Cn, UpdateOrganizationParams as Co, BillingPaymentChargeType as Cp, LocalizationValue as Cr, ExternalAccountResource as Cs, RevokeAPIKeyParams as Ct, ResetPasswordEmailCodeAttempt as Cu, APIKeyResource as D, HslaColorString as Da, SamlIdpSlug as Dc, PasswordSettingsData as Dd, OKXWalletWeb3Provider as Df, DeletedObjectJSON as Di, SignInFutureResetPasswordPhoneCodeVerifyParams as Dl, ClerkPaginatedResponse as Dm, SignInFields as Dn, ActiveSessionResource as Do, BillingPaymentStatus as Dp, FieldId as Dr, EnterpriseConnectionTestRunJSON as Ds, SetActive as Dt, ResetPasswordPhoneCodeFactor as Du, AuthConfigResource as E, HslaColor as Ea, SamlIdpMap as Ec, PasskeySettingsData as Ed, MetamaskWeb3Provider as Ef, ClientTrustState as Ei, SignInFutureResetPasswordPhoneCodeSendParams as El, ClerkResourceReloadParams as Em, SignInErrors as En, OrganizationMembershipRequestResource as Eo, BillingPaymentResource as Ep, CardActionId as Er, EnterpriseConnectionTestRunInitResource as Es, SDKMetadata as Et, ResetPasswordPhoneCodeAttempt as Eu, AuthenticateWithSolanaParams as F, SignUpAuthenticateWithSolanaParams as Fa, EmailAddressJSONSnapshot as Fc, PhoneCodeChannel as Fd, CoinbaseOauthProvider as Ff, IdentificationLinkJSON as Fi, AttemptSecondFactorParams as Fl, UIVersion as Fm, WaitlistErrors as Fn, GetTokenOptions as Fo, BillingStatementResource as Fp, CustomPage as Fr, EnterpriseConnectionTestRunResource as Fs, SignOut as Ft, PasskeyResource as Fu, ClerkOptions as G, FirstNameAttribute as Ga, PasskeyJSONSnapshot as Gc, AttemptAffiliationVerificationParams as Gd, HuggingfaceOAuthProvider as Gf, PartialWithClerkResource as Gi, SignInSecondFactor as Gl, isKnownError as Gn, SessionVerifyAttemptFirstFactorParams as Go, CheckoutFlowResource as Gp, SignUpFuturePasswordParams as Gr, EnterpriseOAuthConfigJSON as Gs, TaskSetupMFAProps as Gt, SignatureVerificationAttemptParam as Gu, ClerkAppearanceTheme as H, SignUpVerifiableField as Ha, OrganizationJSONSnapshot as Hc, ProtectLoader as Hd, GitlabOauthProvider as Hf, OrganizationMembershipJSON as Hi, SignInFactor as Hl, isClerkError as Hm, is4xxError as Hn, SessionTask as Ho, BillingSubscriptionStatus as Hp, SignUpFutureEmailCodeVerifyParams as Hr, EnterpriseConnectionJSON as Hs, SignUpRedirectOptions as Ht, CreateEmailLinkFlowReturn as Hu, BrowserClerk as I, SignUpAuthenticateWithWeb3Params as Ia, EnterpriseAccountConnectionJSONSnapshot as Ic, PhoneCodeChannelData as Id, CustomOauthProvider as If, ImageJSON as Ii, AuthenticateWithPasskeyParams as Il, createClerkGlobalHookError as Im, WaitlistFields as In, PendingSessionOptions as Io, BillingStatementStatus as Ip, CustomMenuItem as Ir, EnterpriseConnectionTestRunSamlPayloadJSON as Is, SignOutCallback as It, PublicKeyCredentialCreationOptionsWithoutExtensions as Iu, ClerkThemeOptions as J, PasswordAttribute as Ja, PublicUserDataJSONSnapshot as Jc, OrganizationDomainVerificationStatus as Jd, LinearOauthProvider as Jf, PhoneNumberJSON as Ji, SignInStrategy as Jl, isPasswordCompromisedError as Jn, SessionVerifyPrepareFirstFactorParams as Jo, CreateCheckoutParams as Jp, SignUpFutureResource as Jr, EnterpriseSamlConnectionNestedResource as Js, UnsubscribeCallback as Jt, VerificationAttemptParams as Ju, ClerkProp as K, LastNameAttribute as Ka, PhoneNumberJSONSnapshot as Kc, OrganizationDomainResource as Kd, InstagramOauthProvider as Kf, PasskeyJSON as Ki, SignInStartEmailLinkFlowParams as Kl, isMetamaskError as Kn, SessionVerifyAttemptSecondFactorParams as Ko, CheckoutFlowResourceNonStrict as Kp, SignUpFuturePhoneCodeSendParams as Kr, EnterpriseOAuthConfigResource as Ks, TasksRedirectOptions as Kt, StartEmailLinkFlowParams as Ku, BrowserClerkConstructor as L, SignUpCreateParams as La, EnterpriseAccountJSONSnapshot as Lc, PhoneCodeProvider as Ld, DiscordOauthProvider as Lf, LastAuthenticationStrategy as Li, PrepareFirstFactorParams as Ll, ClerkRuntimeError as Lm, WaitlistSignal as Ln, PendingSessionResource as Lo, BillingStatementTotals as Lp, ClientResource as Lr, EnterpriseConnectionTestRunSamlPayloadResource as Ls, SignOutOptions as Lt, PublicKeyCredentialRequestOptionsWithoutExtensions as Lu, AuthenticateWithGoogleOneTapParams as M, PrepareVerificationParams as Ma, ClientJSONSnapshot as Mc, UserSettingsResource as Md, AtlassianOauthProvider as Mf, EnvironmentJSON as Mi, SignInFutureTicketParams as Ml, ClerkUIConstructor as Mm, SignUpSignal as Mn, CheckAuthorizationParamsWithCustomPermissions as Mo, BillingPlanUnitPriceTier as Mp, SelectId as Mr, EnterpriseConnectionTestRunOauthPayloadResource as Ms, SignInModalProps as Mt, Web3SignatureConfig as Mu, AuthenticateWithMetamaskParams as N, SignUpAttributeField as Na, CommerceSettingsJSONSnapshot as Nc, UsernameSettingsData as Nd, BitbucketOauthProvider as Nf, ExternalAccountJSON as Ni, SignInFutureWeb3Params as Nl, ClerkUIInstance as Nm, SignUpSignalValue as Nn, CheckAuthorizationWithCustomPermissions as No, BillingProrationCreditDetail as Np, UserPreviewId as Nr, EnterpriseConnectionTestRunParsedUserInfoJSON as Ns, SignInProps as Nt, Web3SignatureFactor as Nu, APIKeysNamespace as O, RgbaColor as Oa, APIKeysSettingsJSON as Oc, SignInData as Od, SolanaWeb3Provider as Of, DisplayThemeJSON as Oi, SignInFutureResetPasswordSubmitParams as Ol, ClerkPaginationParams as Om, SignInSignal as On, CheckAuthorization as Oo, BillingPerUnitTotal as Op, MenuId as Or, EnterpriseConnectionTestRunJSONSnapshot as Os, SetActiveNavigate as Ot, ResetPasswordPhoneCodeFactorConfig as Ou, AuthenticateWithOKXWalletParams as P, SignUpAuthenticateWithMetamaskParams as Pa, DisplayConfigJSONSnapshot as Pc, VerificationStrategy as Pd, BoxOauthProvider as Pf, FeatureJSON as Pi, AttemptFirstFactorParams as Pl, ComponentControls as Pm, State as Pn, GetToken as Po, BillingStatementGroup as Pp, InstanceType as Pr, EnterpriseConnectionTestRunParsedUserInfoResource as Ps, SignInRedirectOptions as Pt, CredentialReturn as Pu, CreateOrganizationModalProps as Q, Jwt as Qa, SignUpVerificationJSONSnapshot as Qc, OrganizationCreationAdvisorySeverity as Qd, NotionOauthProvider as Qf, PublicUserDataJSON as Qi, PhoneNumberIdentifier as Ql, isUnauthorizedError as Qn, CreateEmailAddressParams as Qo, GetPaymentAttemptsParams as Qp, SignUpFutureVerifications as Qr, UpdateMeEnterpriseConnectionParams as Qs, UserProfileProps as Qt, ClerkAPIErrorJSON as Qu, CheckoutErrors as R, SignUpField as Ra, EnvironmentJSONSnapshot as Rc, PhoneCodeSMSChannel as Rd, DropboxOauthProvider as Rf, OrganizationDomainJSON as Ri, PrepareSecondFactorParams as Rl, isClerkRuntimeError as Rm, WaitlistSignalValue as Rn, PublicUserData as Ro, BillingSubscriptionItemResource as Rp, SignUpEnterpriseConnectionResource as Rr, EnterpriseConnectionTestRunStatus as Rs, SignUpButtonProps as Rt, PublicKeyCredentialWithAuthenticatorAssertionResponse as Ru, EnvironmentResource as S, EmUnit as Sa, EnterpriseAccountResource as Sc, AttributesJSON as Sd, Web3Strategy as Sf, BillingSubscriptionItemSeatsJSON as Si, SignInFuturePasskeyParams as Sl, Simplify as Sm, FieldError as Sn, UpdateMembershipParams as So, BillingPayerResourceType as Sp, LocalizationResource as Sr, ImageResource as Ss, Resources as St, ResetPasswordCodeFactor as Su, SharedSignedInAuthObjectProperties as T, HexColorString as Ta, SamlIdp as Tc, OAuthProviders as Td, EthereumWeb3Provider as Tf, ClientJSON as Ti, SignInFuturePhoneCodeVerifyParams as Tl, ClerkResource as Tm, NullableWaitlistSignal as Tn, PermissionResource as To, BillingPaymentMethodStatus as Tp, AlertId as Tr, EnterpriseConnectionTestRunInitJSON as Ts, RoutingStrategy as Tt, ResetPasswordEmailCodeFactorConfig as Tu, ClerkAuthenticateWithWeb3Params as U, SignUpVerificationResource as Ua, OrganizationMembershipJSONSnapshot as Uc, OrganizationSettingsJSON as Ud, GoogleOauthProvider as Uf, OrganizationMembershipRequestJSON as Ui, SignInFirstFactor as Ul, ClerkAPIError as Um, isCaptchaError as Un, SessionTouchIntent as Uo, CancelSubscriptionParams as Up, SignUpFutureEmailLinkSendParams as Ur, EnterpriseConnectionJSONSnapshot as Us, TaskChooseOrganizationProps as Ut, CreateEnterpriseSSOLinkFlowReturn as Uu, Clerk as V, SignUpUpdateParams as Va, OrganizationCreationDefaultsJSONSnapshot as Vc, ProtectConfigResource as Vd, GithubOauthProvider as Vf, OrganizationJSON as Vi, SignInCreateParams as Vl, ClerkError as Vm, is429Error as Vn, SessionStatus as Vo, BillingSubscriptionResource as Vp, SignUpFutureCreateParams as Vr, CreateMeEnterpriseConnectionParams as Vs, SignUpProps as Vt, CodeVerificationAttemptParam as Vu, ClerkEventPayload as W, SignUpVerificationsResource as Wa, OrganizationSettingsJSONSnapshot as Wc, OrganizationSettingsResource as Wd, HubspotOauthProvider as Wf, OrganizationSuggestionJSON as Wi, SignInIdentifier as Wl, isClerkAPIError as Wm, isEmailLinkError as Wn, SessionTouchParams as Wo, CheckoutFlowFinalizeParams as Wp, SignUpFutureFinalizeParams as Wr, EnterpriseConnectionResource as Ws, TaskResetPasswordProps as Wt, PasskeyVerificationResource as Wu, CreateBulkOrganizationInvitationParams as X, ActClaimType as Xa, SignInJSONSnapshot as Xc, PrepareAffiliationVerificationParams as Xd, LinkedinOauthProvider as Xf, PublicKeyCredentialRequestOptionsJSON as Xi, EmailAddressIdentifier as Xl, isReverificationCancelledError as Xn, SessionWithActivitiesResource as Xo, ForPayerType as Xp, SignUpFutureTicketParams as Xr, MeEnterpriseConnectionProvider as Xs, UserButtonProps as Xt, VerificationStatus as Xu, CreateAPIKeyParams as Y, ActClaim as Ya, SessionJSONSnapshot as Yc, OrganizationEnrollmentMode as Yd, LinkedinOIDCOauthProvider as Yf, PublicKeyCredentialCreationOptionsJSON as Yi, UserData as Yl, isPasswordPwnedError as Yn, SessionVerifyPrepareSecondFactorParams as Yo, FeatureResource as Yp, SignUpFutureSSOParams as Yr, MeEnterpriseConnectionOidcInput as Ys, UserAvatarProps as Yt, VerificationResource as Yu, CreateOrganizationInvitationParams as Z, AgentActClaim as Za, SignUpJSONSnapshot as Zc, UpdateEnrollmentModeParams as Zd, MicrosoftOauthProvider as Zf, PublicOrganizationDataJSON as Zi, EmailAddressOrPhoneNumberIdentifier as Zl, isUnauthenticatedError as Zn, SignedInSessionResource as Zo, GetPaymentAttemptParams as Zp, SignUpFutureUpdateParams as Zr, MeEnterpriseConnectionSamlInput as Zs, UserProfileModalProps as Zt, ClerkAPIError$1 as Zu, UseSessionListReturn as _, Web3WalletJSON as _a, SessionVerificationStatus as _c, Actions as _d, PhoneCodeStrategy as _f, BillingProrationCreditDetailJSON as _i, SignInFutureEmailCodeVerifyParams as _l, Override as _m, TelemetryCollector as _n, GetRolesResponse as _o, BillingMoneyAmount as _p, OAuthConsentScope as _r, PhoneNumberVerificationStrategy as _s, OrganizationListProps as _t, PasswordFactor as _u, SAML_IDPS as a, SignInSecondFactorJSON as aa, ActJWTClaim as ac, NewSubscriptionRedirectUrl as ad, DisplayConfigResource as af, BillingCreditsJSON as ai, Web3WalletJSONSnapshot as al, InitializePaymentMethodParams as am, __experimental_ConfigureSSOProps as an, OrganizationMembershipResource as ao, TwitchOauthProvider as ap, ErrorThrower as ar, GetUserOrganizationMembershipParams as as, HandleEmailLinkVerificationParams as at, EmailCodeFactor as au, UseSignUpReturn as b, Color as ba, OrganizationInvitationStatus as bc, AttributeDataJSON as bd, TOTPStrategy as bf, BillingStatementTotalsJSON as bi, SignInFutureMFAEmailCodeVerifyParams as bl, RemoveFunctions as bm, TelemetryLogEntry as bn, OrganizationResource as bo, BillingPayerMethods as bp, MultiDomainAndOrProxy as br, OrganizationSuggestionResource as bs, OrganizationSwitcherProps as bt, PhoneCodeFactor as bu, getWeb3ProviderData as c, SignUpVerificationJSON as ca, JWTClaims as cc, SignInFallbackRedirectUrl as cd, BackupCodeStrategy as cf, BillingPayerCreditJSON as ci, AttemptWeb3WalletVerificationParams as cl, RemovePaymentMethodParams as cm, __internal_AttemptToEnableEnvironmentSettingParams as cn, OrganizationSystemPermissionPrefix as co, XOauthProvider as cp, ClerkOfflineError as cr, SetProfileImageParams as cs, HeadlessBrowserClerk as ct, EmailLinkFactor as cu, RoutingMode as d, TokenJSON as da, ReverificationConfig as dc, SignUpForceRedirectUrl as dd, EmailLinkStrategy as df, BillingPaymentMethodJSON as di, GenerateSignatureParams as dl, DeepCamelToSnake as dm, __internal_EnableOrganizationsPromptProps as dn, GetDomainsParams as do, CommerceSettingsResource as dp, parseError as dr, UserResource as ds, IsomorphicClerkOptions as dt, OAuthConfig as du, SessionActivityJSON as ea, EmailAddressResource as ec, ClerkRuntimeError$1 as ed, OrganizationCreationDefaultsJSON as ef, ApiKeyJSON as ei, TokenJSONSnapshot as el, GetPlanParams as em, WaitlistProps as en, JwtPayload as eo, OAuthProviderData as ep, ClerkWebAuthnError as er, CreatePhoneNumberParams as es, CreateOrganizationProps as et, Web3WalletIdentifier as eu, ProtectParams as f, UserDataJSON as fa, SessionVerificationAfterMinutes as fc, ComplexityErrors as fd, EnterpriseSSOStrategy as ff, BillingPerUnitTotalJSON as fi, PrepareWeb3WalletVerificationParams as fl, DeepPartial as fm, __internal_OAuthConsentProps as fn, GetInvitationsParams as fo, AddPaymentMethodParams as fp, parseErrors as fr, VerifyTOTPParams as fs, ListenerCallback as ft, OauthFactor as fu, UseAuthReturn as g, WaitlistJSON as ga, SessionVerificationSecondFactor as gc, ZxcvbnResult as gd, PasswordStrategy as gf, BillingPlanUnitPriceTierJSON as gi, SignInFutureEmailCodeSendParams as gl, Nullable as gm, __internal_UserVerificationProps as gn, GetRolesParams as go, BillingInitializedPaymentMethodResource as gp, OAuthConsentInfoJSON as gr, PhoneNumberResource as gs, OAuthConsentProps as gt, PasswordAttempt as gu, PublishableKey as h, VerificationJSON as ha, SessionVerificationResource as hc, ValidatePasswordCallbacks as hd, PasskeyStrategy as hf, BillingPlanUnitPriceJSON as hi, SignInFutureCreateParams as hl, ForceNull as hm, __internal_UserVerificationModalProps as hn, GetMemberships as ho, BillingCredits as hp, OAuthConsentInfo as hr, AttemptPhoneNumberVerificationParams as hs, NavigateOptions as ht, PasskeyFactor as hu, OAUTH_PROVIDERS as i, SignInFirstFactorJSON as ia, TokenResource as ic, AuthenticateWithRedirectParams as id, DisplayConfigJSON as if, BillingCheckoutTotalsJSON as ii, VerificationJSONSnapshot as il, GetSubscriptionParams as im, __experimental_CheckoutOptions as in, OrganizationCustomRoleKey as io, TiktokOauthProvider as ip, EmailLinkErrorCodeStatus as ir, GetUserOrganizationInvitationsParams as is, GoogleOneTapProps as it, EmailCodeConfig as iu, AuthenticateWithCoinbaseWalletParams as j, AttemptVerificationParams as ja, AuthConfigJSONSnapshot as jc, UserSettingsJSON as jd, AppleOauthProvider as jf, EnterpriseAccountJSON as ji, SignInFutureTOTPVerifyParams as jl, ClerkUI as jm, SignUpFields as jn, CheckAuthorizationParamsFromSessionClaims as jo, BillingPlanUnitPrice as jp, ProfileSectionId as jr, EnterpriseConnectionTestRunOauthPayloadJSON as js, SignInInitialValues as jt, Web3Attempt as ju, APIKeysProps as k, RgbaColorString as ka, APIKeysSettingsResource as kc, SignUpData as kd, Web3Provider as kf, EmailAddressJSON as ki, SignInFutureResource as kl, ClerkPaginationRequest as km, SignInSignalValue as kn, CheckAuthorizationFn as ko, BillingPerUnitTotalTier as kp, OrganizationPreviewId as kr, EnterpriseConnectionTestRunLogJSON as ks, SetActiveParams as kt, TOTPAttempt as ku, sortedOAuthProviders as l, SignUpVerificationsJSON as la, JWTHeader as lc, SignInForceRedirectUrl as ld, CustomOAuthStrategy as lf, BillingPayerJSON as li, AuthenticateWithWeb3Params as ll, Autocomplete as lm, __internal_AttemptToEnableEnvironmentSettingResult as ln, UpdateOrganizationMembershipParams as lo, XeroOauthProvider as lp, MissingExpiredTokenError as lr, UpdateUserParams as ls, HeadlessBrowserClerkConstructor as lt, EnterpriseSSOConfig as lu, ShowWhenCondition as m, UserOrganizationInvitationJSON as ma, SessionVerificationLevel as mc, PasswordValidation as md, OAuthStrategy as mf, BillingPlanJSON as mi, SignInFutureBackupCodeVerifyParams as ml, DeepSnakeToCamel as mm, __internal_SubscriptionDetailsProps as mn, GetMembershipRequestParams as mo, BillingCheckoutTotals as mp, OAuthApplicationNamespace as mr, TOTPResource as ms, LoadedClerk as mt, PasskeyAttempt as mu, ServerGetToken as n, SessionVerificationJSON as na, IdentificationLinkResource as nc, AfterSignOutUrl as nd, CaptchaProvider as nf, BackupCodeJSON as ni, UserJSONSnapshot as nl, GetStatementParams as nm, __experimental_CheckoutButtonProps as nn, VersionedJwtPayload as no, SlackOauthProvider as np, EmailLinkError as nr, GetEnterpriseConnectionsParams as ns, DecorateUrl as nt, BackupCodeFactor as nu, WEB3_PROVIDERS as o, SignUpEnterpriseConnectionJSON as oa, ClerkJWTClaims as oc, RedirectOptions as od, PreferredSignInStrategy as of, BillingInitializedPaymentMethodJSON as oi, SignInJSON as ol, MakeDefaultPaymentMethodParams as om, __experimental_PlanDetailsButtonProps as on, OrganizationPermissionKey as oo, TwitterOauthProvider as op, ErrorThrowerOptions as or, GetUserOrganizationSuggestionsParams as os, HandleOAuthCallbackParams as ot, EmailCodeSecondFactorConfig as ou, ShowProps as p, UserJSON as pa, SessionVerificationFirstFactor as pc, PasswordStrength as pd, GoogleOneTapStrategy as pf, BillingPerUnitTotalTierJSON as pi, Web3WalletResource as pl, DeepRequired as pm, __internal_PlanDetailsProps as pn, GetMembersParams as po, BillingCheckoutResource as pp, GetOAuthConsentInfoParams as pr, UserOrganizationInvitationResource as ps, ListenerOptions as pt, PassKeyConfig as pu, ClerkStatus as q, LegalAcceptedAttribute as qa, ProtectConfigJSONSnapshot as qc, OrganizationDomainVerification as qd, LineOauthProvider as qf, PermissionJSON as qi, SignInStatus as ql, isNetworkError as qn, SessionVerifyCreateParams as qo, ConfirmCheckoutParams as qp, SignUpFuturePhoneCodeVerifyParams as qr, EnterpriseSamlConnectionNestedJSON as qs, TransferableOption as qt, StartEnterpriseSSOLinkFlowParams as qu, ServerGetTokenOptions as r, SessionWithActivitiesJSON as ra, BackupCodeResource as rc, AuthenticateWithPopupParams as rd, CaptchaWidgetType as rf, BillingCheckoutJSON as ri, UserSettingsJSONSnapshot as rl, GetStatementsParams as rm, __experimental_CheckoutCacheState as rn, OrganizationCustomPermissionKey as ro, SpotifyOauthProvider as rp, EmailLinkErrorCode as rr, GetOrganizationMemberships as rs, GetAPIKeysParams as rt, EmailCodeAttempt as ru, getOAuthProviderData as s, SignUpJSON as sa, JWT as sc, RedirectUrlProp as sd, AppleIdTokenStrategy as sf, BillingMoneyAmountJSON as si, SignInResource as sl, PaymentGateway as sm, __experimental_SubscriptionDetailsButtonProps as sn, OrganizationSystemPermissionKey as so, VercelOauthProvider as sp, buildErrorThrower as sr, RemoveUserPasswordParams as ss, HandleSamlCallbackParams as st, EmailLinkConfig as su, InitialState as t, SessionJSON as ta, PrepareEmailAddressVerificationParams as tc, AfterMultiSessionSingleSignOutUrl as td, OrganizationCreationDefaultsResource as tf, AuthConfigJSON as ti, UserDataJSONSnapshot as tl, GetPlansParams as tm, WithoutRouting as tn, SessionStatusClaim as to, OAuthScope as tp, MetamaskError as tr, CreateWeb3WalletParams as ts, CustomNavigation as tt, BackupCodeAttempt as tu, ClerkHostRouter as u, TOTPJSON as ua, OrganizationsJWTClaim as uc, SignUpFallbackRedirectUrl as ud, EmailCodeStrategy as uf, BillingPaymentJSON as ui, GenerateSignature as ul, CamelToSnake as um, __internal_CheckoutProps as un, AddMemberParams as uo, CommerceSettingsJSON as up, errorToJSON as ur, UpdateUserPasswordParams as us, InternalClerkScriptProps as ut, EnterpriseSSOFactor as uu, UseSessionReturn as v, BoxShadow as va, SessionVerificationTypes as vc, Attribute as vd, ResetPasswordEmailCodeStrategy as vf, BillingStatementGroupJSON as vi, SignInFutureEmailLinkSendParams as vl, PathValue as vm, TelemetryEvent as vn, InviteMemberParams as vo, BillingNamespace as vp, OAuthConsentScopeJSON as vr, PreparePhoneNumberVerificationParams as vs, OrganizationProfileModalProps as vt, PhoneCodeAttempt as vu, EnableEnvironmentSettingParams as w, HexColor as wa, EnterpriseProvider as wc, OAuthProviderSettings as wd, CoinbaseWalletWeb3Provider as wf, ClerkResourceJSON as wi, SignInFuturePhoneCodeSendParams as wl, Without as wm, NullableSignUpSignal as wn, RoleResource as wo, BillingPaymentMethodResource as wp, __internal_LocalizationResource as wr, ReauthorizeExternalAccountParams as ws, RoutingOptions as wt, ResetPasswordEmailCodeFactor as wu, UseUserReturn as x, ColorString as xa, EnterpriseAccountConnectionResource as xc, Attributes as xd, TicketStrategy as xf, BillingSubscriptionItemJSON as xi, SignInFutureMFAPhoneCodeVerifyParams as xl, Serializable as xm, Errors as xn, SetOrganizationLogoParams as xo, BillingPayerResource as xp, MultiDomainAndOrProxyPrimitives as xr, OrganizationSuggestionStatus as xs, PricingTableProps as xt, PhoneCodeSecondFactorConfig as xu, UseSignInReturn as y, BuiltInColors as ya, OrganizationInvitationResource as yc, AttributeData as yd, ResetPasswordPhoneCodeStrategy as yf, BillingStatementJSON as yi, SignInFutureFinalizeParams as yl, RecordToPath as ym, TelemetryEventRaw as yn, InviteMembersParams as yo, BillingPayerCredit as yp, DomainOrProxyUrl as yr, SetReservedForSecondFactorParams as ys, OrganizationProfileProps as yt, PhoneCodeConfig as yu, CheckoutSignal as z, SignUpIdentificationField as za, ExternalAccountJSONSnapshot as zc, PhoneCodeWhatsAppChannel as zd, EnstallOauthProvider as zf, OrganizationDomainVerificationJSON as zi, ResetPasswordParams as zl, ClerkAPIResponseError$1 as zm, JoinWaitlistParams as zn, SessionActivity as zo, BillingSubscriptionItemSeats as zp, SignUpResource as zr, EnterpriseConnectionTestRunsPaginatedJSON as zs, SignUpInitialValues as zt, PublicKeyCredentialWithAuthenticatorAttestationResponse as zu };
//# sourceMappingURL=index-BRHEKtxw.d.mts.map