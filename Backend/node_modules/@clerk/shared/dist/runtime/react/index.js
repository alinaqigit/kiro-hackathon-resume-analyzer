...
const require_organization = require('../organization-HmMQ10g2.js');
...
function getClerkQueryClient() {
	...
	if (!initialized) {
		clerkQueryClient = new __tanstack_query_core.QueryClient();
		initialized = true;
	}
...
function __createClerkTestQueryClient() {
	const client = new __tanstack_query_core.QueryClient({ defaultOptions: { queries: {
		retry: false,
		staleTime: Infinity,
