import { $ as CreateOrganizationParams, $u as ClerkAPIResponseError$1, Am as DeletedObjectResource, Ap as BillingPlanResource, B as CheckoutSignalValue, Bp as BillingSubscriptionPlanPeriod, D as APIKeyResource, Dm as ClerkPaginatedResponse, Dt as SetActive, Eo as OrganizationMembershipRequestResource, Ep as BillingPaymentResource, Fp as BillingStatementResource, G as ClerkOptions, Gp as CheckoutFlowResource, Kd as OrganizationDomainResource, Lr as ClientResource, Qs as UpdateMeEnterpriseConnectionParams, V as Clerk, Vp as BillingSubscriptionResource, Vs as CreateMeEnterpriseConnectionParams, Ws as EnterpriseConnectionResource, Xp as ForPayerType, Zo as SignedInSessionResource, _ as UseSessionListReturn, ao as OrganizationMembershipResource, as as GetUserOrganizationMembershipParams, bo as OrganizationResource, bs as OrganizationSuggestionResource, do as GetDomainsParams, ds as UserResource, fo as GetInvitationsParams, hr as OAuthConsentInfo, is as GetUserOrganizationInvitationsParams, mc as SessionVerificationLevel, mo as GetMembershipRequestParams, mt as LoadedClerk, os as GetUserOrganizationSuggestionsParams, po as GetMembersParams, pp as BillingCheckoutResource, pr as GetOAuthConsentInfoParams, ps as UserOrganizationInvitationResource, q as ClerkStatus, rt as GetAPIKeysParams, t as InitialState, tf as OrganizationCreationDefaultsResource, v as UseSessionReturn, wp as BillingPaymentMethodResource, x as UseUserReturn, yc as OrganizationInvitationResource, zm as ClerkAPIResponseError } from "../index-BRHEKtxw.mjs";
 ...
 * @interface
 */
type UseOAuthConsentParams = Partial<Pick<GetOAuthConsentInfoParams, 'oauthClientId' | 'scope'>> & {
  /**
   * If `true`, the previous data will be kept in the cache until new data is fetched.
   *
   * @default true
...
//#endregion
export { ClerkContextProvider, ClerkInstanceContext, InitialStateProvider, OptionsContext, PaymentElementProps, PaymentElementProviderProps, UNSAFE_PortalProvider, UseOAuthConsentParams, UseOAuthConsentReturn, UseOrganizationCreationDefaultsParams, UseOrganizationCreationDefaultsReturn, UsePaymentElementReturn, type UseSubscriptionParams, UseUserEnterpriseConnectionsParams, UseUserEnterpriseConnectionsReturn, __createClerkTestQueryClient, __experimental_CheckoutProvider, PaymentElement as __experimental_PaymentElement, PaymentElementProvider as __experimental_PaymentElementProvider, useCheckout as __experimental_useCheckout, usePaymentAttempts as __experimental_usePaymentAttempts, usePaymentElement as __experimental_usePaymentElement, usePaymentMethods as __experimental_usePaymentMethods, usePlans as __experimental_usePlans, useStatements as __experimental_useStatements, useSubscription as __experimental_useSubscription, useClientBase as __internal_useClientBase, useOrganizationBase as __internal_useOrganizationBase, usePaymentAttemptQuery as __internal_usePaymentAttemptQuery, __internal_usePlanDetailsQuery, useSessionBase as __internal_useSessionBase, useStatementQuery as __internal_useStatementQuery, useUserBase as __internal_useUserBase, useUserEnterpriseConnections as __internal_useUserEnterpriseConnections, __resetClerkQueryClientForTest, __setClerkQueryClientForTest, assertContextExists, createContextAndHook, getClerkQueryClient, isDeeplyEqual, useAPIKeys, useAssertWrappedByClerkProvider, useAttemptToEnableOrganizations, useClerk, useClerkInstanceContext, useDeepEqualMemo, useInitialStateContext, useOAuthConsent, useOptionsContext, useOrganization, useOrganizationCreationDefaults, useOrganizationList, usePortalRoot, useReverification, useSafeLayoutEffect, useSession, useSessionList, useUser };
