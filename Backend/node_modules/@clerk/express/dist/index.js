...
var requestToProxyRequest = (req) => {
  ...
  return new Request(url.toString(), {
    method: req.method,
    headers,
    body: hasBody ? import_stream.Readable.toWeb(req) : void 0,
...
var clerkClient = new Proxy(clerkClientSingleton, {
  get(_target, property) {
    ...
    const client = (0, import_backend.createClerkClient)({ ...env, userAgent: `${"@clerk/express"}@${"2.1.13"}` });
    if (env.secretKey) {
...
var authenticateRequest = (opts) => {
  ...
  if (isSatellite && !(0, import_proxy2.isHttpOrHttps)(signInUrl) && (0, import_keys.isDevelopmentFromSecretKey)(secretKey || "")) {
...
var absoluteProxyUrl = (relativeOrAbsoluteUrl, baseUrl) => {
  if (!relativeOrAbsoluteUrl || !(0, import_proxy2.isValidProxyUrl)(relativeOrAbsoluteUrl) || !(0, import_proxy2.isProxyUrlRelative)(relativeOrAbsoluteUrl)) {
